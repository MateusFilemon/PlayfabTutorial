...
namespace PlayFab
{
    ...
    public static class PlayFabClientAPI
    {
        ...
        public static void RegisterPLayFabUser(Request request, object createAccountSucess, object createAccountFail)
        {
            throw new NotImplementedException();
        }

        public static void RegisterPLayFabUser(object request, object createAccountSucess, object createAccountFail)
        {
            throw new NotImplementedException();
        }

        public static void RegisterPLayFabUser(RegisterPlayFabUserRequest request, object createAccountSucess, object createAccountFail)
        {
            throw new NotImplementedException();
        }
    }
